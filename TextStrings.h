...
#define STR_libusb_get_device_descriptor_ERR               _("Bekomme USB Descriptor nicht via libusb_get_device_descriptor")
#define STR_libusb_open_ERR                                _("Fehler beim Öffnen des USB Gerätes via libusb_open: ")
#define STR_USB_FOUND                                      _("USB Zündung gefunden - ")
#define STR_USB_NOT_FOUND                                  _("USB Zündung NICHT gefunden !!!")
