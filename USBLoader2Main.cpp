...
USBLoader2Frame::USBLoader2Frame(wxWindow* parent,wxWindowID id)
{
    ...
    StaticText2 = new wxStaticText(PanelBasis, ID_STATICTEXT2, _("Fester Zuendzeitpunkt:"), wxDefaultPosition, wxDefaultSize, wxWANTS_CHARS, _T("ID_STATICTEXT2"));
    ...
    StaticText3 = new wxStaticText(PanelBasis, ID_STATICTEXT3, _("Spule laden:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    ...
    SpinCtrl3 = new wxSpinCtrl(PanelBasis, ID_SPINCTRL3, _T("270"), wxDefaultPosition, wxSize(120,30), 0, 90, 320, 270, _T("ID_SPINCTRL3"));
    SpinCtrl3->SetValue(_T("270"));
    FlexGridSizer1->Add(SpinCtrl3, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    StaticText5 = new wxStaticText(PanelBasis, ID_STATICTEXT5, _("Grad"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
    FlexGridSizer1->Add(StaticText5, 1, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    StaticText31 = new wxStaticText(PanelBasis, ID_STATICTEXT31, _("Aktive Tabelle:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT31"));
    ...
    FlexGridSizer2 = new wxFlexGridSizer(4, 3, 10, 0);
