...
//(*InternalHeaders(TestAUIManagerFrame)
#include <wx/intl.h>
#include <wx/string.h>
//*)
...
//(*IdInit(TestAUIManagerFrame)
const long TestAUIManagerFrame::ID_RADIOBUTTON1 = wxNewId();
const long TestAUIManagerFrame::ID_RADIOBUTTON2 = wxNewId();
const long TestAUIManagerFrame::ID_RADIOBUTTON3 = wxNewId();
const long TestAUIManagerFrame::ID_STATICTEXT2 = wxNewId();
const long TestAUIManagerFrame::ID_SPINCTRL2 = wxNewId();
const long TestAUIManagerFrame::ID_STATICTEXT4 = wxNewId();
const long TestAUIManagerFrame::ID_STATICTEXT3 = wxNewId();
const long TestAUIManagerFrame::ID_SPINCTRL3 = wxNewId();
const long TestAUIManagerFrame::ID_STATICTEXT5 = wxNewId();
const long TestAUIManagerFrame::ID_RADIOBUTTON4 = wxNewId();
const long TestAUIManagerFrame::ID_RADIOBUTTON5 = wxNewId();
const long TestAUIManagerFrame::ID_RADIOBUTTON6 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL2 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL3 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL4 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL5 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL6 = wxNewId();
const long TestAUIManagerFrame::ID_NOTEBOOK1 = wxNewId();
const long TestAUIManagerFrame::ID_TEXTCTRL2 = wxNewId();
const long TestAUIManagerFrame::ID_PANEL1 = wxNewId();
const long TestAUIManagerFrame::idMenuQuit = wxNewId();
const long TestAUIManagerFrame::idMenuVerbinden = wxNewId();
const long TestAUIManagerFrame::idMenuTrennen = wxNewId();
const long TestAUIManagerFrame::idMenuAbout = wxNewId();
const long TestAUIManagerFrame::ID_STATUSBAR1 = wxNewId();
//*)

BEGIN_EVENT_TABLE(TestAUIManagerFrame,wxFrame)
    //(*EventTable(TestAUIManagerFrame)
    //*)
END_EVENT_TABLE()

TestAUIManagerFrame::TestAUIManagerFrame(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(TestAUIManagerFrame)
    ...
    Connect(idMenuQuit,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&TestAUIManagerFrame::OnQuit);
    Connect(idMenuVerbinden,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&TestAUIManagerFrame::OnConnectUsb);
    Connect(idMenuTrennen,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&TestAUIManagerFrame::OnDisconnectUsb);
    Connect(idMenuAbout,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&TestAUIManagerFrame::OnAbout);
    //*)
}

TestAUIManagerFrame::~TestAUIManagerFrame()
{
    //(*Destroy(TestAUIManagerFrame)
    //*)
}

void TestAUIManagerFrame::OnQuit(wxCommandEvent& event)
{
    Close();
}

void TestAUIManagerFrame::OnAbout(wxCommandEvent& event)
{
...
void TestAUIManagerFrame::OnDisconnectUsb(wxCommandEvent& event)
{
    wxString s;
...
void TestAUIManagerFrame::OnConnectUsb(wxCommandEvent& event)
{
    wxString s;
